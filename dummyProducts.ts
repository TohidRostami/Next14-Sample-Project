...
export const products:Product[] = [
    {
      ...
      description: "High-quality wireless headphones with noise-canceling technology and up to 20 hours of battery life.",
    ...
    },
    {
      ...
      price: "$399.99",
      category: "Electronics",
      description: "50-inch 4K UHD Smart LED TV with built-in streaming apps and voice control.",
    ...
    },
    {
      ...
      price: "$19.99",
      category: "Outdoors",
      description: "Insulated stainless steel water bottle with a leak-proof lid, keeps drinks cold for 24 hours.",
    ...
    },
    {
      ...
      price: "$999.99",
      category: "Electronics",
      description: "High-performance gaming laptop with a powerful GPU, 16GB RAM, and 512GB SSD.",
    ...
    },
    {
      ...
      price: "$29.99",
      category: "Kitchen",
      description: "Durable non-stick frying pan, perfect for cooking with minimal oil.",
